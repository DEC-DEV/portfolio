...
public class SavingsItemDTO {
    ...
    public SavingsItemDTO(int i_no, String i_name, String account_num, int i_balance, String id, String i_summary, Timestamp i_date, Double i_rate, Integer i_type, Integer i_min_date, Integer i_max_date, String i_notice, String i_auto_date) {
        this.i_no = i_no;
        this.i_name = i_name;
        this.account_num = account_num;
        this.i_balance = i_balance;
