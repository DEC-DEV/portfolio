...
/*        for(int i = 0; i<list.size(); i++) {
    ...
    class AccountAdapter extends ArrayAdapter<AccountDTO> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if(convertView == null) { // null 일때 처음 한번만 xml을 이용해서 View 생성
                ...
                convertView = inflater.inflate(R.layout.activity_searchaccount_list, null);
            }
    ...
    public class InnerTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            AccountAdapter adapter = new AccountAdapter(getBaseContext(), R.layout.activity_searchaccount_list, list);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView parent, View view, int position, long id) {
                    ...
                    intent.putExtra("state",list.get(position).getAccount_state());
