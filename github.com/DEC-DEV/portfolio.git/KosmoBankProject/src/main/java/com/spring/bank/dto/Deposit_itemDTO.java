...
public class Deposit_itemDTO {
	...
	public String toString() {
		return "Deposit_itemDTO [y_name=" + y_name + ", y_summary=" + y_summary + ", y_date=" + y_date
				+ ", y_interest_rate=" + y_interest_rate + ", y_type=" + y_type + ", y_start_date=" + y_start_date
				+ ", y_end_date=" + y_end_date + ", y_min_price=" + y_min_price + ", y_notice=" + y_notice + ", y_no="
				+ y_no + "]";
	}
	public Deposit_itemDTO(String y_name, String y_summary, Timestamp y_date, Double y_interest_rate, int y_type,
			int y_start_date, int y_end_date, int y_min_price, String y_notice, int y_no) {
		super();
		this.y_name = y_name;
		this.y_summary = y_summary;
		this.y_date = y_date;
