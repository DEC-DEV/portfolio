...
public class FundDTO {
	...
	public String toString() {
		return "FundDTO [f_num=" + f_num + ", id=" + id + ", f_title=" + f_title + ", f_content=" + f_content
				+ ", f_start_date=" + f_start_date + ", f_end_date=" + f_end_date + ", f_target_money=" + f_target_money
				+ ", f_category=" + f_category + ", f_approve=" + f_approve + ", f_name=" + f_name + ", f_phone="
				+ f_phone + ", f_email=" + f_email + ", f_account=" + f_account + ", f_filename=" + f_filename + "]";
	}
