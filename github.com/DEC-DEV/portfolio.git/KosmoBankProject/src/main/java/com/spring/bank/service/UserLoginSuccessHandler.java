...
public class UserLoginSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		String authority = sqlSession.selectOne("com.spring.bank.dao.CustomerDAO.authorityChk", authentication.getName());
		
		// 접속 이력 UPDATE
		sqlSession.update("com.spring.bank.dao.CustomerDAO.update_login_history", authentication.getName().trim() );
