           ...
           <%@ include file="/WEB-INF/views/common/customer/header.jsp" %>
                   ...
                   <div class="row justify-content-center">
                       <div class="col-lg-7" style="padding-top:150">
                           <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                              <h6 class="position-relative d-inline text-primary ps-4">계좌 개설</h6>
              ...
              <div class="container  px-lg-5" style="padding-top: 0px;">
                 <div class="" style="padding-top: 1rem;">
                     ...
                     <span>계좌가입은 KOS뱅크 계좌만 가능합니다.</span>
                  </div>
                  <div class="" style="padding-top: 1rem;">
                     ...
                     <div>
                       ...
                       <a id="account_chk2" class="btn py-sm-3 px-sm-5 rounded-pill mb-4" style="color: black"><strong class="fs-customer-5">KOS뱅크 통장 금리안내</strong></a>
                    </div>
                                ...
                                <tr >
                                 ...
                                 <tr style="text-align: center; border-bottom : 1px solid">
                                  ...
                                  <tr style="text-align: center;border-bottom : 1px solid">
                                    ...
                                    <td>
                                       <input type="text" name="account_bank_name" class="btn py-sm-3 px-sm-5" value="KOS뱅크" readonly >
                                    </td>
                                 </tr>
                                   <tr style="text-align: center;border-bottom : 1px solid">
                                     <td style="border-bottom : 1px solid"> 비밀번호 </td>
                                     <td>
                                        <input type="password" name="account_password" class="btn py-sm-3 px-sm-5">
                                     </td>
                                 </tr>     
