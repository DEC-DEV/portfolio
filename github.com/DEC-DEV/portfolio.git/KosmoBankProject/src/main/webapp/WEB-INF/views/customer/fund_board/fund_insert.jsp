    ...
    <script>
		$(function () {
			$("#btnSave").click(function () { /*등록 버튼 클릭시 작동, 주의사항 : input type = "button"*/
				/* alert("btnSave"); */
				document.fund_insert_action.submit(); /* action에서 지정한 페이지로 이동 */
			});
		});
	</script>
</head>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7" style="padding-top:80">
                        <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h2 class="mt-2">펀드이야기 등록</h2>
                        </div>
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
	                        <form name="fund_insert_action" action="${path}/fund_insert_action.do" method="post">
	                            ...
	                            <table class="table table-hover">
				  				...
				  				<div>
									<a href="${path}/fund_list_search.do"><input type="button" class="btn btn-primary" value="목록"></a>
