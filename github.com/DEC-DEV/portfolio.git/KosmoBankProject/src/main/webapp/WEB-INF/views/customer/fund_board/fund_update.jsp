	...
	<script>
		$(function () {
			...
			$("#btnUpdate").click(function () { /*등록 버튼 클릭시 작동, 주의사항 : input type = "button"*/
				...
				document.form1.action="${path}/fund_update_action.do?${_csrf.parameterName}=${_csrf.token}"
			...
			$("#btnDelete").click(function () { /*등록 버튼 클릭시 작동, 주의사항 : input type = "button"*/
				if(confirm("삭제하시겠습니까?")) {
					document.form1.action="${path}/fund_delete_action.do?${_csrf.parameterName}=${_csrf.token}"
					document.form1.submit();
				}
			});
		});
	                            ...
	                            <table class="table table-hover">
								  <thead>
								    ...
								    <tr>
								    	...
								    	<td class="col-md-1"><input type="text" id="title" name="title" value="${dto.f_title}"></td>
								    	<th class="col-md-1">비밀번호</th>
								    	<td class="col-md-1">
								    		<input id="password" name="password" type="password" value="${dto.f_password}">
								    	</td>
								    </tr>
								  </thead>
								  <tbody>
								    <tr>
								    	<td colspan="5"><textarea id="content" name="content" cols="125" rows="10" style="border:none">${dto.f_content}</textarea></td>
								    </tr>
								    <tr>
