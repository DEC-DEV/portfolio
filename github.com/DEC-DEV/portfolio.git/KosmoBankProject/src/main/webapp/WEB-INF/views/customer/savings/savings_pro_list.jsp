    ...
    <div id="wrapper">
     ...
     <div class="container-fluid align-bottom mt-5 pl-5 pr-5" style="padding-top: 4em; width:70%" >
    	   <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <h2 class="mt-2">적금 상품 리스트</h2>
          </div>
	    <ul class="card list-group list-group-flush">
	    <c:forEach items="${list}" var="dto">
		  <li class="list-group-item" style="padding:25px;">  
		  	<h4 class="mb-1" style="color:#008485">${dto.i_name}</h4>
			<h5>${dto.i_summary}</h5>
			<br><strong> ${dto.i_rate}%</strong> 
		   	<div class="float-right" style="padding-bottom: 1em">
		   		<button type="button" class="btn btn-primary bi bi-cart-dash-fill" onclick="window.location='${path}/savings_order_add.do?i_no=${dto.i_no}&i_name=${dto.i_name}'"></button>
		    </div>	
		 </li>    
		</c:forEach> 			
		</ul>
