...
$(function(){
	$("#btnPay").click(function(){
		 if ( ($("#addMoney").val()) > (document.getElementById("i_summary").value/ 10)) {
			 swal('\추가납입 한도 초과 입니다 ! \n\n최대 현재 이체한도금액의 10%  까지 추가신청 가능합니다. ',{
				 icon: "error"
			 });
		...
		// 비번체크 컨트롤러	
		 ...
		 console.log('한도:',document.getElementById('i_summary').value/10);
	});
});
</script>
	...
	<form method="post" name="mainform">
		<!-- 메인 컨텐츠 시작 -->
         <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s" style="padding-top:100px">
             ...
             <h2 class="mt-2"> 적금추가납입 </h2>
             	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
         </div>

		<div id="title2">추가 납입 계좌</div>
		<hr id="hr" width="80%" />
		<table id="table" align="center" width="50%">
			<tr>
				...
				<td style="display:flex;">
				    ...
				    <input type="button" value="계좌조회" id="btnSearch" class="btn" style="background:#fce08b;color:#333;margin-left:10px;"> 
		...
		<div align="center">
			<input type="button" value="추가납입" id="btnPay" class="btn fw-bold" style="background:#d3dbf1;color:#0b7bed;">
